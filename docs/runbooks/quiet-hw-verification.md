...
| `gate-prefill-attr.out` | [M4b.13 spec](../superpowers/specs/2026-07-17-m4b13-prefill-gemm-register-tiles-vnni-design.md) §Amendments | matmul_share (sum of prefill table's matmul:* rows / prefill total) and ceiling-check arithmetic pp_ratio / (1 - matmul_share * 0.5) >= 1.0 |
