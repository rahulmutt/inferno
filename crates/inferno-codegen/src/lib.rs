...
/// global). Folded into `inferno-core`'s artifact cache key. "4" = M4b.3's
/// attention kernel symbols (`inferno_attention_f32_{scalar,avx2}`); "3" was M4b.2's
/// GEMM dispatch + optional profiling (v2 was M4b.1's `inferno_par_gemv`).
pub const HOST_ABI_VERSION: &str = "4";
